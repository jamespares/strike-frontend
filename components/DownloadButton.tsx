...
export function DownloadButton({ 
  ...
  const baseStyles = "px-4 py-2 rounded-xl text-sm font-semibold transform hover:scale-105 active:scale-95 transition duration-200 ease-in-out shadow-lg hover:shadow-xl flex items-center gap-2"
